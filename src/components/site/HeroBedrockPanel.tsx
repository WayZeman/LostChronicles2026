  ...
  return (
    <div className={cn(shell, className)}>
      ...
      <CopyableMcSlot copyText={address} className="mt-2" copiedLabel="Адресу скопійовано">
        <p className="break-all text-center font-mono text-base font-semibold leading-snug tracking-tight text-[var(--mc-ink)] md:text-lg">
          {address}
        </p>
      </CopyableMcSlot>
      ...
      <CopyableMcSlot copyText={port} className="mt-2" copiedLabel="Порт скопійовано">
        <p className="text-center font-mono text-base font-bold leading-snug tracking-tight text-[var(--mc-ink)] md:text-lg">
          {port}
        </p>
      </CopyableMcSlot>
    </div>
