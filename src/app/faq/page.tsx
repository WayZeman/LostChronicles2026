      ...
      <div className="site-container relative z-10 mx-auto w-full max-w-4xl px-4 py-12 md:py-16">
        ...
        >
          {faqs.map((faq) => (
            ...
            >
              <AccordionTrigger className="text-left text-[15px] font-bold text-[var(--mc-text)] hover:text-[var(--mc-net-green)] hover:no-underline">
                {faq.question}
              </AccordionTrigger>
              <AccordionContent className="text-sm font-medium leading-relaxed text-[var(--mc-text)]">
                <div
                  className="lc-faq-answer max-w-none"
